...
class robot_kinematic_mine(object):
    def __init__(self, base_link, ee_link):
        ...
        self.joint_lower_limits = [0, 0, -np.pi*(146+151)/180, 0, 0]
        self.joint_upper_limits = [np.pi*(169+169)/180, np.pi*(90+65)/180, 0, np.pi*(102.5+102.5)/180, np.pi*(167.5+167.5)/180]
